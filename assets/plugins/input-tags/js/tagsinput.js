...
(function ($) {
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      // Throw an error when trying to add an Objects while the itemValue option was not set
  ...
  /**
    ...
    * @param Objects keyPressEvent: JavaScript event Objects, refer
    *     http://www.w3.org/TR/2003/WD-DOM-Level-3-Events-20030331/ecma-script-binding.html
    * @param Objects lookupList: expected key combinations, as in:
