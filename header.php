    ...
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center gap-1">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="index3.html#" data-bs-toggle="dropdown"><span class="alert-count">7</span>
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="index3.html#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <span class="alert-count">8</span>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="index3.html#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
