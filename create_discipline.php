                ...
                <div class="col-xl-6 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <h5 class="mb-4">Adding a discipline</h5>
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button onclick="addDiscipline()" type="button" class="btn btn-primary px-4">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function addDiscipline() {
        var settings = {
            "url": "/API/Admin/create_discipline.php",
            "method": "POST",
            "timeout": 0,
            "headers": {
                "Content-Type": "text/plain"
            },
            "data": "{\"disciplineName\":\"" + $("#name").val() + "\"}",
        };
